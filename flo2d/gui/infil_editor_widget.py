...
from qgis._core import QgsVectorLayer, QgsProject, QgsRasterLayer, QgsRasterFileWriter, QgsRasterPipe, \
...
class GreenAmptDialog(uiDialog_green, qtBaseClass_green):
    ...
    def calculate_osm(self):
        ...
        if rlayer.isValid():
            ...
            pd.setValue(10)
            land_cover_vector = QgsVectorLayer(osm.landuse_vectorizor(land_cover),"Land Use OSM")
