    ...
    def check_schematized_channel(self):
        ...
        try:
            ...
            if msg != "":
                ...
                self.uc.bar_info("The schematized channel has passed all required checks! The Channel switch is now enabled.")
                self.uc.log_info("The schematized channel has passed all required checks! The Channel switch is now enabled.")
