...
CREATE TABLE "infil" (
    ...
    "fhortoni" REAL DEFAULT 0.0, -- FHORTONI, global Hortonâ€™s equation initial infiltration rate
    "fhortonf" REAL DEFAULT 0.0, -- FHORTONF, global Hortonâ€™s equation final infiltration rate
    "decaya" REAL DEFAULT 0.0 --DECAYA, Hortonâ€™s equation decay coefficient
);
...
CREATE TABLE "infil_areas_horton" (
    "fid" INTEGER NOT NULL PRIMARY KEY,
    "fhorti" REAL, -- FHORTI, Hortonâ€™s equation floodplain initial infiltration rate
    "fhortf" REAL, -- FHORTF, Hortonâ€™s equation floodplain final infiltration rate
    "deca" REAL --DECA, Hortonâ€™s equation decay coefficient
);
...
CREATE TABLE "breach_global" (
    ...
    "gcnc" REAL DEFAULT 0.2, -- GCNC, global Manningâ€™s n-value of the levee or dam core material
    ...
    "gcns" REAL DEFAULT 0.2, -- GCNS, global Manningâ€™s n-value of the levee or dam shell material
...
CREATE TABLE "breach" (
    ...
    "cnc" REAL DEFAULT 0.2, -- CNC, global Manningâ€™s n-value of the levee or dam core material
    ...
    "cns" REAL DEFAULT 0.2, -- CNS, Manningâ€™s n-value of the levee or dam shell material
