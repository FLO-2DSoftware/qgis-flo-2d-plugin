...
CREATE TABLE "culvert_equations" (
    ...
    "multibarrels" INTEGER DEFAULT 1 -- MULTBARRELS, Multiple barrel option for generalized culvert equation
);
...
SELECT gpkgAddGeometryColumn('schema_md_cells', 'geom', 'POLYGON', 0, 0, 0);
