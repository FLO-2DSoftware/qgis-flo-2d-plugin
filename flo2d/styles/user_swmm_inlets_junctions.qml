...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="1e+08" version="3.10.9-A Coruña" simplifyDrawingHints="0" styleCategories="AllStyleCategories" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" labelsEnabled="0">
  ...
  <aliases>
    ...
    <alias field="sd_type" index="2" name=""/>
    <alias field="name" index="3" name=""/>
    <alias field="intype" index="4" name=""/>
    <alias field="junction_invert_elev" index="5" name=""/>
    <alias field="max_depth" index="6" name=""/>
    <alias field="init_depth" index="7" name=""/>
    <alias field="surcharge_depth" index="8" name=""/>
    <alias field="ponded_area" index="9" name=""/>
    <alias field="outfall_invert_elev" index="10" name=""/>
    <alias field="outfall_type" index="11" name=""/>
    <alias field="tidal_curve" index="12" name=""/>
    <alias field="time_series" index="13" name=""/>
    <alias field="flapgate" index="14" name=""/>
    <alias field="swmm_length" index="15" name=""/>
    <alias field="swmm_width" index="16" name=""/>
    <alias field="swmm_height" index="17" name=""/>
    <alias field="swmm_coeff" index="18" name=""/>
    <alias field="swmm_feature" index="19" name=""/>
    <alias field="curbheight" index="20" name=""/>
    <alias field="swmm_clogging_factor" index="21" name=""/>
    <alias field="swmm_time_for_clogging" index="22" name=""/>
    <alias field="swmm_allow_discharge" index="23" name=""/>
    <alias field="water_depth" index="24" name=""/>
    <alias field="rt_fid" index="25" name=""/>
    <alias field="outf_flo" index="26" name=""/>
    <alias field="invert_elev_inp" index="27" name=""/>
    <alias field="max_depth_inp" index="28" name=""/>
    <alias field="rim_elev_inp" index="29" name=""/>
    <alias field="rim_elev" index="30" name=""/>
    <alias field="ge_elev" index="31" name=""/>
    <alias field="difference" index="32" name=""/>
    <alias field="notes" index="33" name=""/>
  </aliases>
