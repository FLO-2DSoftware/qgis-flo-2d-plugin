...
<qgis styleCategories="Symbology" version="3.36.1-Maidenhead">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" is_animated="0" force_rhr="0" frame_rate="10" name="0">
        ...
        <layer locked="0" class="SimpleFill" id="{ee48ecfd-6909-4dfb-a6c9-f1e90b3c14e3}" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="74,37,17,255,rgb:0.29019607843137257,0.14509803921568629,0.06666666666666667,1" type="QString" name="color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" type="fill" is_animated="0" force_rhr="0" frame_rate="10" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleFill" id="{860d97bd-167b-43e0-9ce8-4a2cff51a3fd}" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
