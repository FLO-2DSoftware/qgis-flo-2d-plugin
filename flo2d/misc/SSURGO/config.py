...
CONUS_NLCD_SSURGO = {
    ...
    "SSURGO_Soil": "https://sdmdataaccess.sc.egov.usda.gov/Spatial/SDMWGS84GEOGRAPHIC.wfs?SERVICE=WFS&VERSION=1.1.0&REQUEST=GetFeature&TYPENAME=chorizon&SRSNAME=EPSG:4326&BBOX={}",
}
